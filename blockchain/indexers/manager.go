...
// -----------------------------------------------------------------------------
// dbPutIndexerTip使用现有的数据库事务来更新或添加
//给定索引到所提供值的当前提示。
...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *drcutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *drcutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *drcutil.Block,
	stxo []blockchain.SpentTxOut) error {
