...
func GetBlockWeight(blk *drcutil.Block) int64 {
...
func GetTransactionWeight(tx *drcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *drcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
