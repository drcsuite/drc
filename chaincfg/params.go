...
type Params struct {
	...
	// TargetTimespan是在检查块难度要求之前应该经过的期望时间量，以确定应该如何更改它，以保持期望的块生成速率。
	...
	// TargetTimePerBlock是生成每个块所需的时间量。
	// TargetTimePerBlock is the desired amount of time to generate each
	// block.
	TargetTimePerBlock time.Duration

	// retargetadjustment mentfactor是一个调整因子，用来限制在困难的retargets之间可能发生的最小和最大调整量。
	...
	// MinDiffReductionTime是指在没有找到某个块的情况下，需要减少的最小难度所需的时间。
