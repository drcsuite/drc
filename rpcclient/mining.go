...
func (c *Client) SubmitBlockAsync(block *drcutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *drcutil.Block, options *btcjson.SubmitBlockOptions) error {
