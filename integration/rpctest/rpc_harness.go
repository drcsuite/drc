...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []drcutil.Address{h.wallet.coinbaseAddr}
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() drcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*drcutil.Tx, blockVersion int32,
	blockTime time.Time) (*drcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*drcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*drcutil.Block, error) {
	...
	prevBlock := drcutil.NewBlock(mBlock)
