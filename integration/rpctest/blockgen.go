...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr drcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*drcutil.Tx, error) {
...
func CreateBlock(prevBlock *drcutil.Block, inclusionTxs []*drcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr drcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*drcutil.Block, error) {
	...
	blockTxns := []*drcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := drcutil.NewBlock(&block)
