...
import (
	...
	"github.com/drcsuite/drc/winsvc/mgr"
	"github.com/drcsuite/drc/winsvc/svc"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/drcsuite/drc/winsvc/example").CombinedOutput()
	if err != nil {
