...
import (
	...
	"github.com/drcsuite/drc/drcutil/coinset"
...
func NewCoin(index int64, value drcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = drcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = drcutil.NewTxFromBytes(testSimpleCoinTxBytes)
