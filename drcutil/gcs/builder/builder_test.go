...
import (
	...
	"github.com/drcsuite/drc/drcutilutil"
	"github.com/drcsuite/drc/drcutilutil/gcs"
	"github.com/drcsuite/drc/drcutilutil/gcs/builder"
)
...
func TestUseBlockHash(t *testing.T) {
	...
	// drcutil.Address
	addr, err := drcutil.DecodeAddress(testAddr, &chaincfg.MainNetParams)
	if err != nil {
