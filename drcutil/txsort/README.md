...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/drcsuite/drc/btcutil/txsort)
...
```bash
$ go get -u github.com/drcsuite/drc/btcutil/txsort
```
