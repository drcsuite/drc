...
func TestBlock(t *testing.T) {
	...
	//b := drcutil.NewBlock(&Block100000)
	//
...
func TestNewBlockFromBytes(t *testing.T) {
	...
	//b, err := drcutil.NewBlockFromBytes(block100000Bytes)
	//if err != nil {
...
func TestNewBlockFromBlockAndBytes(t *testing.T) {
	...
	//
	//// Create a new block from the serialized bytes.
	//b := drcutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes)
	//
	//// Ensure we get the same data back out.
	//serializedBytes, err := b.Bytes()
	//if err != nil {
...
func TestBlockErrors(t *testing.T) {
	...
	//testErr := drcutil.OutOfRangeError(wantErr)
	...
	//_, err = drcutil.NewBlockFromBytes(shortBytes)
	//if err != io.EOF {
	...
	//_, err = b.TxHash(-1)
	//if _, ok := err.(drcutil.OutOfRangeError); !ok {
	//	t.Errorf("TxHash: wrong error - got: %v <%T>, "+
	//		"want: <%T>", err, err, drcutil.OutOfRangeError(""))
	//}
