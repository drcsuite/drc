...
func TestEstimateScale(t *testing.T) {
	...
	fmt.Println(EstimateScale([]uint16{45, 46, 47, 48, 49}, []uint16{48, 49, 50, 51, 52}))
	// 投票比300少，说明之前节点估计得多了，最新的节点数要比之前的少，为4666
	fmt.Println(EstimateScale([]uint16{260, 270, 280, 290, 300}, []uint16{4800, 4900, 5000, 5100, 5200}))
	// 投票比300多，说明之前节点估计得少了，最新的节点数要比之前的大，为5333
	fmt.Println(EstimateScale([]uint16{300, 310, 320, 330, 340}, []uint16{4800, 4900, 5000, 5100, 5200}))
}
