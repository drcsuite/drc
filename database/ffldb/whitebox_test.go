...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*drcutil.Block, error) {
	...
	blocks := make([]*drcutil.Block, 0, 256)
	genesis := drcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
